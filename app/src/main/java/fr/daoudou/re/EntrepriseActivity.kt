...
class EntrepriseActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val entrepriseInformationsProgressBar =
            findViewById<ProgressBar>(R.id.progressBarInformations)
        ...
        findViewById<TextView>(R.id.textViewLibelleActivity).setText(
            String.format(
                ...
                entrepriseInformations.libelleActivitePrincipaleEntreprise,
                entrepriseInformations.toString()
            )
        )
        ...
        findViewById<TextView>(R.id.textViewAdresse).setText(
            String.format(
                applicationContext.resources.getString(R.string.adresse_entreprise),
        ...
        findViewById<TextView>(R.id.textViewCodePostal).setText(
            String.format(
                applicationContext.resources.getString(R.string.code_postale),
                entrepriseInformations.codePostaleEntreprise
            )
        )
        findViewById<Button>(R.id.infosRetour).setOnClickListener {
            val intentRetour = Intent(applicationContext, MainActivity::class.java)
